namespace Freeads.Web.CastleWindsor
{
    ...
    public class ComponentRegistrar
    {
        ...
        private static void AddApplicationServicesTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("Freeads.ApplicationServices")
                    .Pick()
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("Freeads.Data")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("Freeads.Core"));
        }
