...
<asp:Content ID="indexContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
	...
	<h3>
		What next?</h3>
	<p>
		Your S#arp Architecture 1.95 project is now setup and ready to go. This release is built on the RTM verion of ASP.NET MVC 3 and .NET 4. The only tasks remaining
		are to:
		<ol>
			<li>
				<span style="font-weight:bold; font-style:italic">Create your database and set the connection string
				within Freeads.Web/NHibernate.config</span>
			</li>
			<li>
				Optionally, modify the Fluent NHibernate preferences within Freeads.Data.NHibernateMaps.GetConventions()
			...
			<li>
				Open Freeads.Tests.dll via NUnit and make sure all the tests are turning green.
			</li>
			<li>
				...
				Freeads.Web.Controllers.RouteRegistrar.RegisterRoutesTo() after the scaffolding generator has completed.)
			</li>
		</ol>
	</p>
	<p>
