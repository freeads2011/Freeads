...
using Freeads.Data.NHibernateMaps;
...
namespace Tests.Freeads.Data.NHibernateMaps
{
    /// <summary>
    ...
    public class MappingIntegrationTests
    {
        ...
        public virtual void SetUp()
        {
            ...
            configuration = NHibernateSession.Init(new SimpleSessionStorage(), mappingAssemblies,
                                   ...
                                   "../../../../app/Freeads.Web/NHibernate.config");
                                   //"C:\\dz\\Source\\Oglasi\\app\\Freeads.Web\\NHibernate.config");
        }
